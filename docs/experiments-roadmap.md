...
| 2026-08-18 | Berlin & Kay (1969) interactive Munsell array built (`/teaching/experiments/berlin-kay`) for Zed's colour class; WCS chip colorimetry via Bradford-adapted Lab→sRGB, 86/330 chips gamut-clipped (disclosed in debrief) |
